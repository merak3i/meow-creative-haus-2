...
const pagePath = "/ai-automation-digital-marketing-udupi";

export const metadata: Metadata = {
  title: "AI Automation & Digital Marketing in Udupi",
  description:
    "AI automation, product engineering, experience engineering, and AI-backed digital marketing from Meow Creative Haus in Udupi.",
  alternates: {
    canonical: pagePath,
  },
  openGraph: {
    title:
      "AI Automation & Digital Marketing in Udupi | Meow Creative Haus",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Meow Creative Haus AI automation and digital marketing studio in Udupi",
      },
    ],
    type: "website",
  },
...
const faqs = [
  {
    question: "What AI automation services do you offer in Udupi?",
    answer:
  ...
  },
  {
    ...
    answer:
      "We start with the outcome, current workflow, users, available data, existing tools, and known failure cases. The first recommendation identifies the smallest useful system, what can be proved quickly, what should remain manual, and how success will be measured. You can begin through WhatsApp or visit the Udupi studio during listed hours.",
  },
] as const;
  ...
  "@graph": [
    {
      ...
      name: "AI Automation & Digital Marketing in Udupi",
      description:
        "Product engineering, experience engineering, AI automation, and AI-backed digital marketing from Meow Creative Haus in Udupi.",
      ...
      <section className="px-6 pb-20 pt-36 md:px-12 md:pb-28 md:pt-44">
        <div className="mx-auto max-w-[1200px]">
          <p className="mb-5 text-label-sm uppercase tracking-[0.2em] text-accent-teal">
            AI automation + digital marketing in Udupi
          </p>
          ...
          <p className="mt-8 max-w-[820px] text-body-lg text-text-muted">
            ...
            result to AI-backed marketing. Based in Udupi, we work from the
